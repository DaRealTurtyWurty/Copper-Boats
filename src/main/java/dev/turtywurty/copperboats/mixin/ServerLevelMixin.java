...
public abstract class ServerLevelMixin extends Level {
    ...
    private boolean copperboats$tickChunk$isRandomlyTicking(boolean original, @Local(argsOnly = true) LevelChunk chunk,
        ...
        var sectionBounds = new AABB(minX, sectionY * LevelChunkSection.SECTION_HEIGHT, minZ, minX + LevelChunkSection.SECTION_WIDTH, sectionY * LevelChunkSection.SECTION_HEIGHT + LevelChunkSection.SECTION_HEIGHT, minZ + LevelChunkSection.SECTION_WIDTH);
